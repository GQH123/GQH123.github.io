...
(function (global, factory) {
  ...
  function actualDisplay(name, doc) {
    var style,
      ...
      display = window.getDefaultComputedStyle && (style = window.getDefaultComputedStyle(
        elem[0])) ?
...
(function ($) {
  ...
  AboutCard.prototype = {
    ...
    dropAboutCard: function () {
      ...
      var offsetTop = ($(window).height() / 2) - (aboutCardHeight / 2) +
        aboutCardHeight;
  ...
  ArchivesFilter.prototype = {
    ...
    showResult: function (numbPosts) {
      if (numbPosts === -1) {
        ...
        this.$archiveResult.html(this.messages.other.replace(/\{n\}/,
          numbPosts)).show();
      }
    },
    /**
    ...
    countPosts: function (date) {
      return $(this.postsDay + '[data-date^=' + date[0] + date[1] + date[
        2] + ']').length;
    },
    /**
...
(function ($) {
  ...
  CategoriesFilter.prototype = {
    ...
    countCategories: function (category) {
      return $(this.posts + '[data-' + this.dataCategory + '*=\'' +
        category + '\']').length;
    },
    /**
    ...
    showPosts: function (category) {
      var self = this;
      var parents;
      var categories = self.categories + '[data-' + self.dataCategory +
        '*=\'' + category + '\']';
      var posts = self.posts + '[data-' + self.dataCategory + '*=\'' +
        category + '\']';
      if (self.countCategories(category) > 0) {
        ...
        if ($(categories + '[data-' + self.dataParentCategories + ']').length) {
          ...
          $(categories).each(function () {
            ...
            parents = $(this).attr('data-' + self.dataParentCategories)
              .split(',');
            // Show only the title of the parents's categories and hide their posts
            parents.forEach(function (parent) {
              var dataAttr = '[data-' + self.dataCategory + '=\'' +
                parent + '\']';
  ...
  $(document).ready(function () {
    ...
    function fancyFox() {
      ...
      $('.fancybox').fancybox({
        ...
        afterLoad: function () {
          setTimeout(function () {
            $('.fancybox-next > span, .fancybox-prev > span').css(
              'visibility', 'visible');
          }, 400);
        }
      });
    ...
    resizeImages: function () {
      ...
      this.$images.each(function () {
        ...
        if (imageHeight < photoBoxHeight) {
          ...
          $image.parent().css({
            left: '-' + (((photoBoxHeight * imageRatio) / 2) - (
              photoBoxWidth / 2)) + 'px'
          });
        }
        ...
        if (imageWidth < photoBoxWidth) {
          ...
          // Center image in his box
          $image.parent().css({
            top: '-' + (((imageHeight) / 2) - (photoBoxHeight / 2)) +
              'px'
          });
        }
  ...
  PostBottomBar.prototype = {
    ...
    swipePostBottomBar: function () {
      ...
      if (this.lastScrollTop > scrollTop &&
        (postFooterOffsetTop + this.$postFooter.height() > scrollTop + $(
            window).height() ||
  ...
  SearchModal.prototype = {
    ...
    showResults: function (posts) {
      ...
      posts.forEach(function (post) {
        ...
        if (post.thumbnailImageUrl) {
          ...
          html += '<a class="link-unstyled" href="' + (post.link ||
            post.permalink) + '">';
    ...
    showResultsCount: function (count) {
      ...
      if (count < 1) {
        ...
        string = this.$resultsCount.data('message-other').replace(/\{n\}/,
          count);
        this.$noResults.hide();
      }
...
(function ($) {
  ...
  Sidebar.prototype = {
    ...
    swipeSidebarToRight: function () {
      ...
      // and prevent multiple click on the open button with `.processing` class
      if (!this.$sidebar.hasClass('pushed') && !this.$sidebar.hasClass(
          'processing')) {
        // Swipe the sidebar to the right
    ...
    swipeSidebarToLeft: function () {
      ...
      if (this.$sidebar.hasClass('pushed') && !this.$sidebar.hasClass(
          'processing')) {
        // Swipe the sidebar to the left
        this.$sidebar.addClass('processing').removeClass(
          'pushed processing');
    ...
    swipeBlogToRight: function () {
      ...
      // and prevent multiple click on the open button with `.processing` class
      if (!this.$blog.hasClass('pushed') && !this.$blog.hasClass(
          'processing')) {
        // Swipe the blog to the right
    ...
    swipeBlogToLeft: function () {
      ...
      // and prevent multiple click on the close button with `.processing` class
      if (self.$blog.hasClass('pushed') && !this.$blog.hasClass(
          'processing')) {
        // Swipe the blog to the left
  ...
  TabbedCodeBlock.prototype = {
    ...
    run: function () {
      ...
      self.$tabbedCodeBlocs.find('.tab').click(function () {
        ...
        var $tabsContent = $codeblock.find('.tabs-content').children(
          'pre, .highlight');
...
(function ($) {
  ...
  var TagsFilter = function (tagsArchivesElem) {
    ...
    this.$inputSearch = $(tagsArchivesElem +
      ' #filter-form input[name=tag]');
